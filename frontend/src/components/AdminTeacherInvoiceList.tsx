...
This is a reminder that your payment for {{month}}, {{year}} is {{due_amount}} TK. 
You are going to be paid {{paid_amount}} TK. We will pay by the first week of this month.
            ...
            <div className="card flex-col divide-y divide-base-300 w-full border border-base-300 mt-5">
                ...
                {sortedInvoices.map((invoice, i) => (
                    <div className="flex flex-wrap" key={i}>
                        <div className='flex-1 font-semibold p-3 sm:py-3 sm:px-5'>{invoice.expand?.teacher.nickname}</div>
                        ...
                        <DialogPanel className="card p-4 bg-base-100 w-full max-w-md">
                            <div className='p-5'>
                                <div className='flex justify-between items-center'>
                                    {/* <div>Invoice of <b>{updateInvoice.expand?.teacher.nickname}</b> for <b>{months.find(e => e.index == updateInvoice.month)?.shortName} {updateInvoice.year}</b></div> */}
